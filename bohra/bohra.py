...
def main():
    ...
    # options for running
    parser.add_argument('--reads','-r',help='Path to reads file, which is a tab-delimited with 3 columns <isolatename>  <path_to_read1> <path_to_read2>. REQUIRED', default='')
    ...
    parser.add_argument('--reference','-ref',help='Path to reference (.gbk or .fa)', default = '')
    parser.add_argument('--mask','-m',default = False, help='Path to mask file if used (.bed)')
