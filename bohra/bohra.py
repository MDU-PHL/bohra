...
def main():
    ...
    parser_sub_run.add_argument('--minaln','-ma',help='Minimum percent alignment. Isolates which do not align to reference at this threshold will not be included in core phylogeny.', default=0)
    parser_sub_run.add_argument('--mincov','-mc',help='Minimum percent alignment. Isolates which do not have average read coverage above this threshold will not be included further analysis.', default=0)
    ...
    parser_sub_run.add_argument('--verbose', action = 'store_true', help = 'Output verbose snakemake')
    # parser for update
