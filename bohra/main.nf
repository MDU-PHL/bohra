...
workflow {
    ...
    include { RUN_ASSEMBLE;CONCAT_MLST;CONCAT_RESISTOMES;COLLATE_ASM_PROKKA;CONCAT_ASM;RUN_SNIPPY;RUN_CORE;RUN_IQTREE;CONCAT_VIRULOMES } from './workflows/default'
    ...
    if (params.mode == 'preview') {
        ...
        results = CONCAT_ASM.out.collated_assembly.concat( RUN_CORE.out.core_stats, CONCAT_VIRULOMES.out.collated_virulomes, CONCAT_RESISTOMES.out.collated_resistomes, CONCAT_MLST.out.collated_mlst )
