...
class RunSnpDetection(object):
    ...
    def write_pipeline_job(self, maskstring,  script_path = f"{pathlib.Path(__file__).parent.parent / 'scripts'}", resource_path = f"{pathlib.Path(__file__).parent.parent / 'templates'}"):
        '''
