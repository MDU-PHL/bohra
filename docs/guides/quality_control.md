...
`bohra` provides some basic quality checks which can be useful to determine the quality of your data (summary tab of the analysis report). The pipeline will NOT remove anything, but will flag sequences which display features that could detrimentally impact the quality of the analysis.
